...
class AnniversaryMessenger implements InterfaceMessenger {

    protected $messageType;
    protected $message;
    protected $anniversariesArray;
    ...
    public function send() {
        ...
        if ($this->_getSentFlag()) {
            ...
            echo "\r\n -- Email contents: " . $this->message .' ' . $anniversaryNamesList . " -- \r\n";
            ...
            mail(
                ...
                $this->message .' ' . $anniversaryNamesList, 
                $headers
            );
            */        
            $this->_setSentFlag();
